...
#define	DQ  	PORTBbits.RB5 	// Pin dati sul quale sono collegate le linee DQ dei dispositivi 1-wire
#define	TRIS_DQ	DDRBbits.RB5	// Registro TRIStato relativo alla porta usata per DQ
